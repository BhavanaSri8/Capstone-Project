...
class ClaimControllerTest {
    ...
    void raiseClaim_returnsCreated() throws Exception {
        ClaimResponse response = new ClaimResponse(1L, 10L, 1000.0, "accident", "PENDING", LocalDateTime.now(), null, List.of());
    ...
    void raiseClaimWithDocuments_returnsCreated() throws Exception {
        ClaimResponse response = new ClaimResponse(2L, 10L, 900.0, "glass", "PENDING", LocalDateTime.now(), null, List.of("proof.pdf"));
    ...
    void approveClaim_returnsOk() throws Exception {
        ClaimResponse response = new ClaimResponse(3L, 10L, 700.0, "damage", "APPROVED", LocalDateTime.now(), "Admin", List.of());
